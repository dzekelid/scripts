...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/scripts/master/_listings/google-apps-script-execution/apis.md
...
- name: Google Apps Script Execution - Run Script
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/scripts/master/_listings/google-apps-script-execution/v1scriptsscriptidrun-post-openapi.md
- name: Google Apps Script Execution - Run Script
  x-api-slug: v1scriptsscriptidrun-post
  description: |-
    Runs a function in an Apps Script project. The project must be deployed
